...
**reason 必須包含五大專業段落**（完整詳細，約 500-800 字）：
...
[
  {
    ...
    "profitTWD": 4994,
    "stopLoss": 45.89,
    "reason": "【演算法訊號】VCP 波動率收縮完成。股價自 11/20 高點 50.5 元回檔至 12/2 低點 44.8 元後，近 6 日在 46.5-48.8 元窄幅整理，振幅收斂至 4.7%。12/9 放量突破整理區，成交量 7,500 張為 20 日均量 3,800 張的 1.97 倍，符合 VCP 突破特徵。\\n\\n【技術面共振】三大指標同步轉強：\\n1. RSI(14) = 61.5，12/8 突破 50 中線轉強。\\n2. MACD(12,26,9) 柱狀圖連續 5 日擴大，當前值 0.55 > 訊號線 0.38。\\n3. 布林通道中軌 47.2 元，上軌 50.1 元。\\n4. 均線多頭排列：5MA(48.2) > 10MA(47.5) > 20MA(46.8)。\\n\\n【籌碼與量價】主力連續買超：\\n近 5 日主力累計買超 3,100 張 (12/4-12/10)，外資連續 4 日買超共 1,800 張。11/28 出現 9,200 張爆量長紅 K，收 45.2 元形成關鍵支撐。\\n\\n【交易計畫】\\n- 進場：47.8-48.2 元分批進場（5MA 支撐 + 整理區上緣）\\n- 停損：45.60 元（-5.0%，跌破 20MA 即出場）\\n- 目標：第一目標 52.80 元（+10.0%），第二目標 54.50 元（+13.5%）\\n- R:R：風險 2.40 元 vs 報酬 4.80 元 = 1:2.0\\n\\n【資金控管建議】建議投入總資金的 25%，分 2-3 批進場。若突破 50.1 元（布林上軌）且量能維持 6,000 張以上可加碼 10%。"
  }
]
\`\`\`

⚠️ **重要提醒**：
- reason 必須包含五大段落的完整專業分析
- 每個段落都要有具體數據支撐
- 交易計畫中的價位必須與 JSON 欄位 (entryPoint, stopLoss, exitPoint) 一致
`;
};
...
【演算法訊號】【技術面共振】【籌碼與量價】【交易計畫】【資金控管建議】

每個段落都要有具體數據，總字數約 500-800 字。
交易計畫中的價位必須與 JSON 欄位 (entryPoint, stopLoss, exitPoint) 一致。`;
